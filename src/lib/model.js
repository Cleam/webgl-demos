...
//模型类
export default function Model(name, isDraw) {
  this.uniforms = {};
  this.u_Matrix = null;
  this.bufferInfo = {};
  this.parent = null;
...
Model.prototype.updateWorldMatrix = function (newMatrix, viewMatrix, projectionMatrix) {
  ...
  this.uniforms.u_Matrix = matrix.multiply(projectionMatrix, this.uniforms.u_Matrix);
};
...
Model.prototype.getWorldMatrix = function (worldMatrix) {
  if (worldMatrix) {
    this.worldMatrix = matrix.multiply(worldMatrix, this.localMatrix, this.worldMatrix);
  } else {
...
*/
  ...
  this.u_Matrix = matrix.multiply(projectionMatrix, this.u_Matrix, this.u_Matrix);
